...
{
    if(fLiteMode) return; // ignore all Worldbit related functionality
...
/*
    ...
    allow endless transaction that would bloat Worldbit and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("worldbit-privatesend");
