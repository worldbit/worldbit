...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "WorldbitNetwork") type = WorldbitNetwork;
    if(strType == "WorldbitNetworkVariable") type = WorldbitNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == WorldbitNetwork) s = "WorldbitNetwork";
    if(type == WorldbitNetworkVariable) s = "WorldbitNetworkVariable";
