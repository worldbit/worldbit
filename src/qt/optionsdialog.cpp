    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("WORLDBIT-light"), QVariant("light"));
    ui->theme->addItem(QString("WORLDBIT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("WORLDBIT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("WORLDBIT-traditional"), QVariant("trad"));
