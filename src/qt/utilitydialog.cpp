    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Worldbit Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Worldbit Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  worldbit-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Worldbit in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 WORLDBIT, 0.1 WORLDBIT, 1 WORLDBIT and 10 WORLDBIT -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://worldbit.atlassian.net/wiki/display/DOC/PrivateSend\">https://worldbit.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Worldbit Core is shutting down...") + "<br /><br />" +
