    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Worldbit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Worldbit address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and worldbit: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Worldbit Core"), this);
    aboutAction->setStatusTip(tr("Show information about Worldbit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Worldbit Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Worldbit addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Worldbit addresses"));
    ...
    openAction->setStatusTip(tr("Open a worldbit: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Worldbit Core help message to get a list with possible Worldbit Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Worldbit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Worldbit network", "", count));
}
...
{
    QString strTitle = tr("Worldbit Core"); // default title
