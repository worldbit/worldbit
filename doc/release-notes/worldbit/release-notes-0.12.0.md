...
Dash Core version 0.12.0 is now available from:
  ...
  https://worldbit.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/worldbit/worldbit/issues
...
worldbitd/worldbit-qt (on Linux).
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/worldbit/).
