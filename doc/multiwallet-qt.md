...
Only requiring some minor changes is worldbit.cpp.
...
Changes to worldbit.cpp
----------------------
worldbit.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
